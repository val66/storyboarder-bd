...
| [positioned-lights.md](positioned-lights.md) | Les sources de lumière posées dans une Scène : pourquoi une lumière est un `objet3d` et non un type neuf (70 sites mesurés), les champs persistés, la fuite de la scène partagée, les trois exclusions voulues (tâche #420). |
