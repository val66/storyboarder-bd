...
journaliser, et rapportait la médiane à côté de la moyenne — la première image d'une session
...
|---|---|---|
| Rendu WebGL d'une Case | **64 %** | ~0,69 rendu par image — le cache 3D absorbe le reste |
...
| « Coalescer les demandes de dessin absorbera une bonne part du travail » | 1018 demandes ont produit 1018 images — elle n'a rien absorbé pendant cette campagne |
...
- **éteinte par défaut**, allumée depuis la console — une sonde toujours active mesure une partie de
  son propre coût ;
