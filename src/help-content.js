...
export const HELP_MANUAL_EN = [
  ...
  { id: 'modeles', title: 'Imported 3D models', paragraphs: [
    ...
    'Which bone each slider drives comes from "Skeleton mapping…", at the bottom of that section; correcting it rebuilds the sliders. Axes are the bone\'s own, so which one bends an elbow depends on the file. The pose library does not apply to imported skeletons yet.',
  ]},
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles', title: 'Modèles 3D importés', paragraphs: [
    ...
    'L\'os piloté vient de « Correspondance du squelette… », en bas de cette section ; le corriger reconstruit les curseurs. Les axes sont ceux de l\'os : lequel plie un coude dépend du fichier. La bibliothèque de poses ne s\'applique pas encore aux squelettes importés.',
  ]},
