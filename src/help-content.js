...
export const HELP_MANUAL_EN = [
  ...
  { id: 'modeles', title: 'Imported 3D models', paragraphs: [
    ...
    'Renaming the file does not rename your Elements: the name shown in a card is yours, and stays as you wrote it.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles', title: 'Modèles 3D importés', paragraphs: [
    ...
    'Renommer le fichier ne renomme pas vos Éléments : le nom affiché dans une fiche est le vôtre, et reste tel que vous l\'avez écrit.',
