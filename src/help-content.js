...
export const HELP_MANUAL_EN = [
  ...
  { id: 'editeur', title: 'Character editor', paragraphs: [
    ...
    'Click a joint point to select it: the other points disappear, and the orange tinted area shows where you can click without losing the selection. Click empty space to deselect. On a creature, hovering a limb or its chain title lights up that chain and its points only.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'editeur', title: 'Éditeur de Personnage', paragraphs: [
    ...
    "Cliquez un point d'articulation pour le sélectionner : les autres disparaissent, et la zone orange montre où cliquer sans perdre la sélection. Cliquer dans le vide désélectionne. Sur une créature, survoler un membre ou le titre de sa chaîne n'allume que cette chaîne et ses points.",
