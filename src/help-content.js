...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles', title: 'Modèles 3D importés', paragraphs: [
    ...
    'Les fichiers sont recopiés dans un dossier « Modeles », à côté de vos projets. Déplacé ou supprimé hors de l\'application, un fichier ne peut plus être lu : ses Éléments deviennent des boîtes signalées « fichier introuvable ».',
