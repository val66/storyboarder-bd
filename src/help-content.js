...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles_articules', title: 'Modèles articulés', paragraphs: [
    ...
    'Une créature s\'ouvre dans l\'Éditeur avec SES articulations : chaque figure s\'y pose dans sa propre langue. C\'est LÀ, et nulle part ailleurs, que les poses se créent : réglez les curseurs, nommez la pose, « Enregistrer » l\'ajoute à la bibliothèque de son archétype. La fiche applique les poses, elle n\'en fabrique plus.',
