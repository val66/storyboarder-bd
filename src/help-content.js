...
export const HELP_MANUAL_EN = [
  ...
  { id: 'modeles_articules', title: 'Rigged models', paragraphs: [
    ...
    'A creature opens in the editor with ITS own joints: every figure is posed in its own language. Set its sliders, name the pose, and "Save" adds it to its archetype\'s library.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles_articules', title: 'Modèles articulés', paragraphs: [
    ...
    'Une créature s\'ouvre dans l\'Éditeur avec SES articulations : chaque figure s\'y pose dans sa propre langue. Réglez ses curseurs, nommez la pose, « Enregistrer » l\'ajoute à la bibliothèque de son archétype.',
