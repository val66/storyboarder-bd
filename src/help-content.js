...
export const HELP_MANUAL_FR = [
  ...
  { id: 'editeur', title: 'Éditeur de modèle', paragraphs: [
    ...
    "Section « Pose » : cliquez une pose pour l'appliquer, ou saisissez un nom puis Enregistrer pour ajouter celle en cours. Renommer et Supprimer valent pour toute pose ; Configuration restaure les poses de base supprimées. Bibliothèque partagée par tous vos Projets.",
