...
export const HELP_MANUAL_EN = [
  ...
  { title: 'Characters', paragraphs: [
    ...
    'In the editor the view ORBITS around the character: hold the RIGHT mouse button to turn around it, scroll wheel to zoom. The view cannot be moved sideways — a lone figure is already centred. Press C to open the Camera section, with numeric rotation, drag sensitivity and a Reframe button.',
    'The small pencil button in the corner of the 3D preview opens a full-screen view: scroll wheel to zoom, and a right-hand panel with one slider per joint. "Reset pose" returns to the pose the editor opened with; nothing is written to the character until you save the dialog, which reopens on close.',
...
export const HELP_MANUAL_FR = [
  ...
  { title: 'Personnages', paragraphs: [
    ...
    "Dans l'éditeur, la vue ORBITE autour du Personnage : maintenez le clic DROIT pour en faire le tour, molette pour zoomer. La vue ne se déplace pas latéralement — une figure seule est déjà centrée. La touche C ouvre la section Caméra, avec rotation numérique, sensibilité du glisser et un bouton Recadrer.",
    "Le petit bouton crayon dans le coin de l'aperçu 3D ouvre une vue plein écran : molette pour zoomer, et un panneau de droite avec un curseur par articulation. « Réinitialiser la pose » revient à la pose d'ouverture ; rien n'est écrit dans le Personnage tant que vous n'avez pas enregistré la modale, qui réapparaît à la fermeture.",
