...
export const HELP_MANUAL_EN = [
  ...
  { id: 'raccourcis', title: 'Keyboard shortcuts', paragraphs: [
    ...
    'E: open the Character editor. On a character or an articulated imported model, it opens on that figure; otherwise on the built-in character.',
    'F: centre the panel\u2019s 3D view on the selected Element. A second press returns to the previous framing.',
    'Ctrl+[ / Ctrl+]: previous / next page, within the current volume.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'raccourcis', title: 'Raccourcis clavier', paragraphs: [
    ...
    'E : ouvrir l\'Éditeur de Personnage. Sur un Personnage ou un Modèle importé articulé, il s\'ouvre sur cette figure ; sinon sur le Personnage intégré.',
    'F : centrer la vue 3D de la Case sur l\'Élément sélectionné. Un second appui revient au cadrage précédent.',
    'Ctrl+[ / Ctrl+] : Planche précédente / suivante, dans le Tome courant.',
