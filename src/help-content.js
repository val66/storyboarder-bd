...
export const HELP_MANUAL_EN = [
  ...
  { title: 'Characters', paragraphs: [
    ...
    '"Apply to character" sends the edited pose back to the dialog and reopens it — nothing is written to the character until you save there, so Cancel still cancels. Closing the editor without applying leaves everything untouched. The button is absent when the editor was not opened from a character.',
...
export const HELP_MANUAL_FR = [
  ...
  { title: 'Personnages', paragraphs: [
    ...
    "« Appliquer au Personnage » renvoie la pose éditée vers la modale et la rouvre — rien n'est écrit dans le Personnage tant que vous n'y avez pas enregistré, donc Annuler annule toujours. Fermer l'éditeur sans appliquer ne change rien. Le bouton est absent si l'éditeur n'a pas été ouvert depuis un Personnage.",
