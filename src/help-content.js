...
export const HELP_MANUAL_EN = [
  ...
  { id: 'images', title: 'Panel images', paragraphs: [
    ...
    'Right-click a panel → "Move the image", or the button in the Image section, to reframe it: drag with the left button. Escape, or a click outside the panel, ends it. Releasing the button does not: you can adjust several times.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'images', title: 'Images de Case', paragraphs: [
    ...
    "Clic droit sur une Case → « Déplacer l'image », ou le bouton de la section Image, pour la recadrer : glissez au bouton gauche. Échap, ou un clic hors de la Case, termine. Relâcher le bouton, non : vous pouvez ajuster plusieurs fois.",
