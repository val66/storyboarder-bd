...
export const HELP_MANUAL_EN = [
  ...
  { id: 'modeles_articules', title: 'Rigged models', paragraphs: [
    ...
    'Set a creature\'s sliders, name the pose, and "Save" adds it to its archetype\'s library. Poses are filed BY ARCHETYPE: a quadruped only sees quadruped poses. A pose REPLACES the sliders; the resulting angles appear in them and stay adjustable. Applied to another model of the same archetype, it says what did not land.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles_articules', title: 'Modèles articulés', paragraphs: [
    ...
    'Réglez les curseurs d\'une créature, nommez la pose, « Enregistrer » l\'ajoute à la bibliothèque de son archétype. Les poses se rangent PAR ARCHÉTYPE : un quadrupède ne voit que des poses de quadrupède. Une pose REMPLACE les curseurs ; les angles obtenus s\'y affichent et restent retouchables. Appliquée à un autre modèle du même archétype, elle dit ce qui n\'a pas atterri.',
