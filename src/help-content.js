...
export const HELP_MANUAL_EN = [
  ...
  { title: 'Characters', paragraphs: [
    ...
    'Save the current pose to the project library from the "Pose" section: type a name, then Save. Rename and Delete only apply to your own poses, never to the built-in ones. Deleting a pose changes no character — their angles were copied when the pose was applied — only the displayed label becomes unknown.',
