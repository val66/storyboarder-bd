...
export const HELP_MANUAL_EN = [
  ...
  { id: 'modeles', title: 'Imported 3D models', paragraphs: [
    ...
    'Its selection box on the Page follows the model\'s own silhouette, measured in the file — a slim figure gets a slim box, not a square one.',
  ]},
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles', title: 'Modèles 3D importés', paragraphs: [
    ...
    'Sa boîte de sélection sur la Planche suit la silhouette du modèle, mesurée dans le fichier — une figure élancée reçoit une boîte élancée, pas un carré.',
  ]},
