...
export const HELP_MANUAL_EN = [
  ...
  { id: 'personnages', title: 'Characters', paragraphs: [
    ...
    'Joints available: neck, head, torso, collarbones, shoulders, elbows, wrists, hips, knees and ankles — the same body an imported skeleton offers, so both are posed with the same words.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'personnages', title: 'Personnages', paragraphs: [
    ...
    "Articulations disponibles : cou, tête, torse, clavicules, épaules, coudes, poignets, hanches, genoux et chevilles — le même corps que celui d'un squelette importé, pour que les deux se posent avec les mêmes mots.",
