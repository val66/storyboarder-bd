...
export const HELP_MANUAL_EN = [
  ...
  { title: 'Characters', paragraphs: [
    ...
    'The small pencil button in the corner of the 3D preview opens a full-screen view: scroll wheel to zoom, drag to move, and a right-hand panel with one slider per joint. "Reset pose" returns to the pose the editor opened with; nothing is written to the character until you save the dialog, which reopens on close.',
