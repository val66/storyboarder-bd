...
export const HELP_MANUAL_FR = [
  ...
  { id: 'images', title: 'Images de Case', paragraphs: [
    ...
    "La section Cadrage zoome, de 1× (le cadrage couvrant) jusqu'à 4× : par son curseur, ou à la molette sur une Case sélectionnée. Elle ne descend pas sous 1×, ce qui empêcherait l'image de remplir la Case. Zoomer libère aussi l'axe qui n'avait pas de marge.",
