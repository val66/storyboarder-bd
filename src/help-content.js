...
export const HELP_MANUAL_EN = [
  ...
  { id: 'personnages', title: 'Characters', paragraphs: [
    ...
    'Joints available: neck, head, torso, collarbones, shoulders, elbows, wrists, hips, knees and ankles — the same body an imported skeleton offers, so both are posed with the same words. The character now has feet, so ankle movement is visible.',
  ...
  { id: 'modeles', title: 'Imported 3D models', paragraphs: [
    ...
    'Click a joint point on the preview to unfold its sliders, and unfolding a group selects its point — same gesture as for Characters. Which bone each slider drives comes from "Mapping table", below. Axes are the bone\'s own, so which one bends an elbow depends on the file. The pose library does not apply to imported skeletons yet.',
  ]},
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'personnages', title: 'Personnages', paragraphs: [
    ...
    "Articulations disponibles : cou, tête, torse, clavicules, épaules, coudes, poignets, hanches, genoux et chevilles — le même corps que celui d'un squelette importé, pour que les deux se posent avec les mêmes mots. Le Personnage a désormais des pieds, ce qui rend le mouvement des chevilles visible.",
  ...
  { id: 'modeles', title: 'Modèles 3D importés', paragraphs: [
    ...
    'Clic droit sur une Case → « Importer » → « Modèle » y pose un objet unique ; « Scène » crée une Scène réutilisable et la charge.',
    ...
    'Les fichiers sont recopiés dans un dossier « Modeles », à côté de vos projets. Un fichier déplacé ou supprimé hors de l\'application ne peut plus être lu : ses Éléments deviennent des boîtes de remplacement, signalées « fichier introuvable ».',
    ...
    'Un modèle porteur d\'un squelette gagne une section « Réglages des articulations » : trois curseurs par articulation reconnue — sauf le bassin, racine du squelette : le tourner ferait pivoter tout le personnage, ce que fait déjà l\'Orientation.',
    'Cliquez un point d\'articulation sur l\'aperçu pour déplier ses curseurs, et déplier un groupe sélectionne son point — même geste que pour les Personnages. L\'os piloté vient de « Tableau de correspondance », plus bas. Les axes sont ceux de l\'os : lequel plie un coude dépend du fichier. La bibliothèque de poses ne s\'applique pas encore aux squelettes importés.',
  ]},
