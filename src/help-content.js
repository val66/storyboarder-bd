...
export const HELP_MANUAL_EN = [
  ...
  { id: 'modeles', title: 'Imported 3D models', paragraphs: [
    ...
    'A model with a skeleton gains a "Joint fine-tuning" section: three sliders per recognised joint — except the hips, which are the skeleton\'s root: turning them rotates the whole figure, which Orientation already does.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'modeles', title: 'Modèles 3D importés', paragraphs: [
    ...
    'Un modèle porteur d\'un squelette gagne une section « Réglage fin des articulations » : trois curseurs par articulation reconnue — sauf le bassin, racine du squelette : le tourner ferait pivoter tout le personnage, ce que fait déjà l\'Orientation.',
