...
export const HELP_MANUAL_EN = [
  ...
  { id: 'images', title: 'Panel images', paragraphs: [
    ...
    'Right-click a panel → "Move the image", or the button in the Image section, to reframe it: drag with the left button. Escape, or a click anywhere outside the panel, ends it. Releasing the button does not: you can adjust several times.',
    ...
    'The Framing slider zooms in, from 1x (the covering fit) up to 4x. It does not go below 1x, which would stop the image from filling the panel. Zooming also frees the axis that had no slack.',
    ...
    'Files are copied into an "Images" folder next to your projects, shared by all of them. One moved or deleted outside the application shows "Image not found", and the panel goes back to normal if it comes back.',
...
export const HELP_MANUAL_FR = [
  ...
  { id: 'images', title: 'Images de Case', paragraphs: [
    ...
    "Clic droit sur une Case → « Déplacer l'image », ou le bouton de la section Image, pour la recadrer : glissez au bouton gauche. Échap, ou un clic n'importe où hors de la Case, termine. Relâcher le bouton, non : vous pouvez ajuster plusieurs fois.",
    "L'image ne peut pas être tirée au-delà de son propre bord : aucune bande blanche n'apparaît. L'axe qui tombe juste sur la Case n'a pas de marge, et ne bouge pas.",
    "Le curseur Cadrage zoome, de 1× (le cadrage couvrant) jusqu'à 4×. Il ne descend pas sous 1×, ce qui empêcherait l'image de remplir la Case. Zoomer libère aussi l'axe qui n'avait pas de marge.",
    ...
    "Clic droit sur une image → « Renommer le fichier… » ou « Supprimer du disque ». Le renommage met à jour les Cases du Projet OUVERT et son historique d'annulation. La suppression ne vide pas les Cases : elles affichent « Image introuvable ».",
  ]},
