...
- 🎭 **Character editor** in full screen: pose library shared across projects (save, rename, delete — built-in poses included), clickable joint points, one slider per joint, mouse zoom/pan, pose reset
